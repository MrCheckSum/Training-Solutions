...
Egy telek jellemzői, páros vagy páratlan oldalon található, (0 = páros oldal 1 = páratlan oldal), a telek hossza méterben.
Illetve egy Fence enum, ami a kerítés állapotát írja le. A kerités állapota lehet, PERFECT, NEED_UPGRADE, NO_FENCE. (konstruktor, getterek)
...
public class Site {
    ...
    public Site(int side, double length, Fence fence) {
        this.side = side;
        this.length = length;
        this.fence = fence;
    }
