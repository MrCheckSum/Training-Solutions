...
public class PrintFormat {
    public String formatMessageWithIntegerParameters(String formatString, Integer i, Integer j) {
        try {
            ...
            throw new IllegalArgumentException("Less objects then expected in format String!", exception);
        }
    }
    ...
    public String printFormattedText(Integer i, Integer j, Integer k) {
        String formatSting = "Multiple objects containing text:%d\t%d\t%d";
        return String.format(new Locale("hu", "HU"), formatSting, i, j, k);
    }
}
