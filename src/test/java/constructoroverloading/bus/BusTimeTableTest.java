...
class BusTimeTableTest {
    ...
    public void constructorTestList() {
        ...
        // When
        assertEquals(5, timetable.getTimeList().size());
        assertEquals(9, timetable.getTimeList().get(0).getHours());
        assertEquals(15, timetable.getTimeList().get(4).getMinutes());
    }
    ...
    public void constructorTestHours() {
        ...
        // When
        assertEquals(3, timetable.getTimeList().size());
        assertEquals(14, timetable.getTimeList().get(0).getHours());
        assertEquals(30, timetable.getTimeList().get(0).getMinutes());
        assertEquals(16, timetable.getTimeList().get(2).getHours());
    }
    ...
    public void nextBusShouldThrowExceptionIfNone() throws IllegalStateException {
        ...
        assertEquals("There is no more bus available!", ex.getMessage());
    }
