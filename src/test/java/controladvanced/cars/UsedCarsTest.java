...
public class UsedCarsTest {
    ...
    @Test
    public void testFilerLines(){
        List<String> csvLines = List.of("CDR-451;1998;Volvo;red",
        ...
        List<String> filtered = new UsedCars().filterLines(csvLines);

        Assertions.assertEquals(3,filtered.size());
        Assertions.assertEquals(List.of("CDR-451;1998;Volvo;red",
                "ROBIN-1;2003;Ferrari;red",
                "FKJ-187;2011;Kia;black"), filtered);
