...
public class TransactionCounterTest {
    ...
    public void testCountEntryLessThan() {
        ...
        Assertions.assertEquals(0, new TransactionCounter().countEntryLessThan(transactions, 1000));
        Assertions.assertEquals(4, new TransactionCounter().countEntryLessThan(transactions, 10000));
    }
}
